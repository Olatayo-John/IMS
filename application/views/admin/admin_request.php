...
<div class="container-fluid mt-4">
	<h4 class="text-center text-light mt-2 mb-2">ADMIN REQUESTS</h4>
	<div class="row mb-5">
		<div class="link_tab col-md-3 d-flex flex-column">
			<?php foreach ($ad_contacts->result_array() as $cnt) : ?>
		...
		<div class="msg_tab col-md-9" id="msg_tab">
			...
			<div class="reply_in">
				<form action="<?php echo base_url('admin/adminrequest') ?>" method="post">
