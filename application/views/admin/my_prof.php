<link rel="stylesheet" href="<?php echo base_url('assets/css/admin/my_profile.css'); ?>">
<?php foreach ($infos as $info) : ?>
	<div class="con mt-3 mr-3 ml-3 mb-3 d-flex flex-row">
		<h4 class="text-dark"><?php echo $info['fname'] . " " . $info['lname'] ?></h4>
	</div>
	<div class="row con_both mt-3 mr-3 ml-3 mb-3">
		<div class="con col con_left">
			<span>
				<h4 class="text-dark">Profile <a href="<?php echo base_url('admin/edit'); ?>"><i class="fas fa-edit float-right" style="color: #00695C;"></i></a></h4>
			</span>
			<hr>
			<div class="prof_img_div mb-2">
				<img src="<?php echo base_url('assets/adm_uploads/' . $info['profile_img']); ?>" class="">
			</div>
...
<script type="text/javascript" src="<?php echo base_url('assets/js/admin/my_profile.js'); ?>"></script>