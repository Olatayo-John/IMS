<link rel="stylesheet" href="<?php echo base_url('assets/css/staff/edit_prof.css'); ?>">
...
<?php foreach ($infos as $info) : ?>
    <div class="con mt-3 mr-3 ml-3 mb-3 prof_div">
        ...
        <form action="<?php echo base_url('staff/save_personal_info'); ?>" method="post" enctype="multipart/form-data">
            ...
            <?php if ($info['profile_img'] === "female_profile.png" || $info['profile_img'] == "male_profile.png" || $info['profile_img'] == "") : ?>
                <div class="d-flex flex-direction-row prof_img_outer_div">
                    <div class="profileimg_div">
                        <?php if ($info['gender'] === "Male") : ?>
                            <img src="<?php echo base_url('assets/stf_uploads/male_profile.png'); ?>">
                        <?php endif; ?>
                        <?php if ($info['gender'] === "Female") : ?>
                            <img src="<?php echo base_url('assets/stf_uploads/female_profile.png'); ?>">
                        <?php endif; ?>
                    </div>
                ...
                <?php elseif ($info['profile_img'] !== "female_profile.png" || $info['profile_img'] !== "male_profile.png") : ?>
                    <div class="profileimg_div col-md-4 form-group">
                        <img src="<?php echo base_url('assets/stf_uploads/' . $info['profile_img']); ?>">
        ...
        <div class="con mt-3 mr-3 ml-3 mb-3 cnt_div">
            ...
            <form action="<?php echo base_url('staff/save_contact'); ?>" method="post">
                <input type="hidden" class="csrf_token" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                <div class="form-group">
        ...
        <div class="con mt-3 mr-3 ml-3 mb-3 ac_div">
            ...
            <form action="<?php echo base_url('staff/save_account'); ?>" method="post">
                <input type="hidden" class="csrf_token" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                <div class="form-group">
    ...
    <?php endforeach; ?>
    <script type="text/javascript" src="<?php echo base_url('assets/js/staff/edit_prof.js'); ?>"></script>
    ...
    <script>
        $(document).ready(function() {
            $(document).on('click', 'i.fa-times-circle', function() {
                ...
                $.ajax({
                    url: "<?php echo base_url('staff/delete_profileimg'); ?>",
                    method: "post",
                    data: {
                        [csrfName]: csrfHash,
                        id: id,
            ...
            $(document).on('click', 'button.yes_btn', function () {
                ...
                $.ajax({
                    url: "<?php echo base_url('staff/deact_account'); ?>",
                    method: "post",
                    data: {
                        userid:userid,
                        [csrfName]:csrfHash
