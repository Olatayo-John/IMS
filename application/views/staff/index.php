<link rel="stylesheet" href="<?php echo base_url('assets/css/staff/index.css'); ?>">
<input type="hidden" name="<?php echo $this->security->get_csrf_token_name() ?>" value="<?php echo $this->security->get_csrf_hash() ?>" class="csrf_token">

<div class="ml-3 mr-3 pt-3 pb-3 row new_srch_std">
	<div class="col">
		<a href="<?php echo base_url('staff/new'); ?>" class="btn text-light" style="background-color: #00695C">
			<i class="fas fa-plus-circle mr-2"></i>New Staff</a>
	</div>
	<div class="ml-auto input-group col">
		<i class="fas fa-search input-group-text d-flex"></i>
...
<div class="pt-3 pb-3 mr-3 ml-3 mt-3 mb-3 filterdiv">
	<div class="d-flex flex-row">
		<div class="">
			<label class="text-dark text-left font-weight-bolder pl-3">Filter by</label>
		</div>
...
<div class="table-responsive std_table_div pr-3 pl-3">
	<table class="table table-light table-bordered std_table table-sm">
...
<script type="text/javascript" src="<?php echo base_url('assets/js/staff/index.js'); ?>"></script>