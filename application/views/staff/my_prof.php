<link rel="stylesheet" href="<?php echo base_url('assets/css/staff/my_profile.css'); ?>">
<?php foreach ($infos as $info) : ?>
	...
	<div class="row con_both mt-3 mr-3 ml-3 mb-3">
		<div class="con col con_left">
			<span>
				<h4 class="text-dark">Profile <a href="<?php echo base_url('staff/edit'); ?>"><i class="fas fa-edit float-right" style="color: #00695C;"></i></a></h4>
			</span>
			<hr>
							...
							<div class="form-group row">
								...
								<div class="form-group row">
									...
									<div class="form-group row">
										...
										<script type="text/javascript" src="<?php echo base_url('assets/js/staff/my_profile.js'); ?>"></script>