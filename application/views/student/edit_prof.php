<link rel="stylesheet" href="<?php echo base_url('assets/css/student/edit_prof.css'); ?>">
<div class="tab_div ml-3 mr-3 mt-3 con">
    <a href="" class="tab_link prof_a">Profile</a>
    <a href="" class="tab_link cnt_a">Contact</a>
    <a href="" class="tab_link course_a">Course</a>
...
<?php foreach ($infos as $info) : ?>
    <div class="con mt-3 mr-3 ml-3 mb-3 prof_div">
        ...
        <form action="<?php echo base_url('student/save_personal_info'); ?>" method="post" enctype="multipart/form-data">
            ...
            <?php if ($info['profile_img'] === "female_profile.png" || $info['profile_img'] == "male_profile.png" || $info['profile_img'] == "") : ?>
                <div class="d-flex flex-direction-row prof_img_outer_div">
                    <div class="profileimg_div">
                        <?php if ($info['gender'] === "Male") : ?>
                            <img src="<?php echo base_url('assets/std_uploads/male_profile.png'); ?>">
                        <?php endif; ?>
                        <?php if ($info['gender'] === "Female") : ?>
                            <img src="<?php echo base_url('assets/std_uploads/female_profile.png'); ?>">
                        <?php endif; ?>
                    </div>
                ...
                <?php elseif ($info['profile_img'] !== "female_profile.png" || $info['profile_img'] !== "male_profile.png") : ?>
                    <div class="profileimg_div col-md-4 form-group">
                        <img src="<?php echo base_url('assets/std_uploads/' . $info['profile_img']); ?>">
        ...
        <div class="con mt-3 mr-3 ml-3 mb-3 cnt_div">
            ...
            <form action="<?php echo base_url('student/save_contact'); ?>" method="post">
                <input type="hidden" class="csrf_token" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                <div class="form-group">
        ...
        <?php foreach ($infos as $info) : ?>
            <div class="con mt-3 mr-3 ml-3 mb-3 course_div">
                <h4 class="text-dark mb-3 mb-3">Course</h4>
                <form action="<?php echo base_url('student/save_course'); ?>" method="post">
                    <input type="hidden" class="csrf_token" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                    <div class="form-group">
                        <label><span class="text-danger">* </span>Course</label>
                        <input type="text" name="course" class="form-control course" value="<?php echo strtoupper($info['course']) ?>">
                    </div>
                    <div class="form-group">
                        <label>Branch</label>
                        <input type="text" name="branch" class="form-control branch" value="<?php echo strtoupper($info['branch']) ?>">
                    </div>
                    <div class="row">
                        <div class="form-group col">
                            <label>Course period from</label>
                            <input type="number" name="started_course_year" class="form-control started_course_year" value="<?php echo strtoupper($info['started_course_year']) ?>" placeholder="<?php echo date('Y') ?>">
                            <span class="started_course_year_err text-danger" style="display:none">Invalid year</span>
                        </div>
                        <div class="form-group col">
                            <label>To</label>
                            <input type="number" name="end_course_year" class="form-control end_course_year" value="<?php echo strtoupper($info['end_course_year']) ?>" placeholder="<?php echo date('Y') ?>">
                            <span class="end_course_year_err text-danger" style="display:none">Invalid year</span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label><span class="text-danger">* </span>Year</label>
                        <input type="number" name="current_course_year" class="form-control current_course_year" value="<?php echo strtoupper($info['current_course_year']) ?>" placeholder="5">
                        <span class="current_course_year_err text-danger" style="display:none">Invalid year</span>
                    </div>
                    <div class="form-group text-left">
                        <button class="btn text-light savecourse_btn" type="submit" style="background-color:#00695C">Save</button>
                    </div>
                </form>
            </div>
        <?php endforeach; ?>
        ...
        <div class="con mt-3 mr-3 ml-3 mb-3 ac_div">
            ...
            <form action="<?php echo base_url('student/save_account'); ?>" method="post">
                <input type="hidden" class="csrf_token" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                <div class="form-group">
    ...
    <?php endforeach; ?>
    <script type="text/javascript" src="<?php echo base_url('assets/js/student/edit_prof.js'); ?>"></script>
    ...
    <script>
        $(document).ready(function() {
            $(document).on('click', 'i.fa-times-circle', function() {
                ...
                $.ajax({
                    url: "<?php echo base_url('student/delete_profileimg'); ?>",
                    method: "post",
                    data: {
                        [csrfName]: csrfHash,
                        id: id,
            ...
            $(document).on('click', 'button.yes_btn', function () {
                ...
                $.ajax({
                    url: "<?php echo base_url('student/deact_account'); ?>",
                    method: "post",
                    data: {
                        userid:userid,
                        [csrfName]:csrfHash
