...
<div class="container-fluid mt-4">
	...
	<div class="row mb-5">
		...
		<div class="msg_tab col-md-9" id="msg_tab">
			...
			<div class="reply_in">
				<form action="<?php echo base_url('student/response') ?>" method="post">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		$('.rmbtn').click(function(e) {
			...
			$.ajax({
				url: "<?php echo base_url('student/show_request') ?>",
				method: "post",
				data: {
					id: id,
					[csrfName]: csrfHash
		...
		$('i.delbtn').click(function() {
			...
			$.ajax({
				url: "<?php echo base_url('student/delete_response') ?>",
				method: "post",
				data: {
					id: id,
					[csrfName]: csrfHash
